//I haven't modified the shader, it's required for display any of the objects
...
public class Shader {
  ...
  public Shader(GL3 gl, String vertexPath, String fragmentPath) {
    try {
      if ((new java.io.File(vertexPath)).exists()) {
        System.out.println("found " + vertexPath);
      } else {
        System.out.println("missing" + vertexPath);
      }
